...
la s1 snakegame2a# endere�o dos dados da tela na memoria
addi s1 s1 8# primeiro pixels depois das informa��es de nlin ncol
LOOP1: beq t1 t2 Entrada# Se for o �ltimo endere�o ent�o sai do loop
...
#sycall contador velocidade nivel
str_speed_int:
li t1 0
li a7 101
mv a0 t1
...
beq t0 zero loop_anterior # = estado anterior #nao tem tecla pressionada entao volta ao loop  ARMAZENAR O BAGUI
lw t2 4(t1)#Le o valor da tecla


#PRA EFETIVAMENTE COLOCAR EFEITO CRESCENTE BASTA POR UM DECREMENTADOR NO SLEEP
loop_anterior:
mv s2 t2
li t3 1000
add a0 t3 t3   # 1 segundo
li a7 132
ecall
...
addi 	t1 t1 11
mv s9 t1
#gerado as coordenadas, hora de printar
mv a0 s8
mv a1 s9
mv a2 x0
mv a3 x0
